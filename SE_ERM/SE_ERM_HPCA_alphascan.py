...
def main():
    ...
    np.savetxt(f"q_alpha_{alpha:.5f}_Lambda_{args.Lambda}_Samples_{args.Nsample}_SE_ERM.txt", q, fmt="%.6f")
    np.savetxt(f"varq_alpha_{alpha:.5f}_Lambda_{args.Lambda}_Samples_{args.Nsample}_SE_ERM.txt",  varq, fmt="%.6f")
    np.savetxt(f"m_alpha_{alpha:.5f}_Lambda_{args.Lambda}_Samples_{args.Nsample}_SE_ERM.txt", m, fmt="%.6f")
    np.savetxt(f"varm_alpha_{alpha:.5f}_Lambda_{args.Lambda}_Samples_{args.Nsample}_SE_ERM.txt",  varm, fmt="%.6f")
